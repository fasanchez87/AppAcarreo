...
import com.ingenia.appacarreo.Activity.InicioServicioConductor;
import com.ingenia.appacarreo.Activity.Login;
import com.ingenia.appacarreo.Adapters.ServiciosAgendadosAdapter;
...
public class ServiciosAgendadosConductor extends Fragment
{
    ...
    private ServiciosAgendadosAdapter mAdapter;
    ...
    public ServiciosAgendadosConductor()
    {
                             ...
                             Bundle savedInstanceState)
    {
        ...
        return inflater.inflate(R.layout.fragment_servicios_agendados_conductor, container, false);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState)
    {
        ...
        recyclerViewServiciosDisponibles = (RecyclerView) this.getActivity().findViewById(R.id.recycler_view_servicios_agendados);
        imagenSinServicios = (ImageView) getActivity().findViewById(R.id.imagenSinServiciosAgendados);
        ...
        mAdapter = new ServiciosAgendadosAdapter(serviciosDisponibles);
                ...
                recyclerViewServiciosDisponibles, new ClickListener()
        {
            ...
            public void onClick(View view, int position)
            {
                ...
                Intent intent = new Intent(ServiciosAgendadosConductor.this.getActivity(),InicioServicioConductor.class);
                ...
                intent.putExtra("movilxTercerox",solicitudServicio.getTelefonoCliente());
                intent.putExtra("nombreTercerox",solicitudServicio.getNombreCliente());
    ...
    public static class RecyclerTouchListener implements RecyclerView.OnItemTouchListener
    {
        ...
        private ServiciosAgendadosConductor.ClickListener clickListener;

        public RecyclerTouchListener(Context context, final RecyclerView recyclerView, final ServiciosAgendadosConductor.ClickListener clickListener) {
    ...
    {
        super.onResume();
        _webServiceObtenerServiciosAgendadosConductor();
    ...
    private void _webServiceObtenerServiciosAgendadosConductor()
    {
        serviciosDisponibles.clear();
        progressDialog = new ProgressDialog(getActivity());
        progressDialog.setIndeterminate(true);
        progressDialog.setMessage("Consultando servicios agendados, espera un momento...");
        progressDialog.show();
        progressDialog.setCancelable(false);
//        buttonSeleccionarServicios.setVisibility(View.GONE);

        final String _urlWebService = vars.ipServer.concat("/tr_panel/wsr/getPedidosConfirmados");
                        ...
                        try
                        {
                            ...
                            else
                            {
                                for (int i = 0; i < response.length(); i++)
                                {
                                    ...
                                    servicio.setTelefonoCliente(jsonObject.getString("movilxTercerox"));
                                    servicio.setNombreCliente(jsonObject.getString("nombreTercerox"));
