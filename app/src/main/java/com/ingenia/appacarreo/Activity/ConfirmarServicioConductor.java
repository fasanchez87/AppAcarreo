...
public class ConfirmarServicioConductor extends AppCompatActivity implements LocationListener,
    ...
    private Button buttonConfirmarServicioConductor;
    ...
    private String direccCarguexx, fechaSolicitud, cantidConfirma, tarifaTotalxxx, cantidAuxiliar, indicaEmbalaje, codigoPediresu,
            latituCarguexx, longitCarguexx, latituDescargu, longitDescargu, codigoClientex,emailxTercerox;

    @Override
    protected void onCreate(Bundle savedInstanceState)
    {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ejecucion_servicio_conductor);

        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbarEjecucionServicioConductorToolbar);
        setSupportActionBar(toolbar);

        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(R.id.mapEjecucionServicioConductor);
        ...
        buttonConfirmarServicioConductor = (Button) findViewById(R.id.buttonConfirmarServicioConductor);
        buttonConfirmarServicioConductor.setOnClickListener(new View.OnClickListener()
        {
            @Override
